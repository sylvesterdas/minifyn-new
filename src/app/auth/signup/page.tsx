                        ...
                        >
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="relative">
                                    ...
                                    <Badge variant="secondary" className="absolute top-0 left-2 -translate-y-1/2 text-xs h-auto py-0.5 px-1.5 text-green-600 bg-green-500/10 border-green-500/20">
                                        Save 15%
                                    </Badge>
                                    <Badge variant="secondary" className="absolute top-0 right-2 -translate-y-1/2 text-xs h-auto py-0.5 px-1.5 text-primary bg-primary/10 border-primary/20">
                                        Best Value
                                    </Badge>
                                </div>
                            </div>
