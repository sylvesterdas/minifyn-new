  ...
  return (
    <div className="container mx-auto px-4 py-12 md:py-24 max-w-4xl">
        <div className="prose prose-invert mx-auto">
            ...
            <p>This policy outlines the terms for cancellations and refunds for the MiniFyn Pro subscription service. MiniFyn is owned and operated by Sylvester Kumar Das (UDYAM-KL-12-0136086).</p>
